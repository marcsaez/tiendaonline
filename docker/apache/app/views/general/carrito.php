    ...
    <section>
        ...
        <div id="resumen-compra">
                        ...
                        foreach ($datosCarrito as $product) {
                            ...
                            echo '<article class="item-carrito">
                                ...
                                <div class="grid-area-cantidad">
                                    <input type="number" class="cantidad" name="cantidad" min="1" max='.$product['productstock'].' id="cantidad" value='.$product['amount'].'>
                                </div>
                                <div>
                                    <p></p>
                                ...
                                <div>
                                    <button class="action-eliminar">  
                                        ...
                                        <a href="index.php?Controller=Carrito&action=deletePurchase&productIDdelete='.$product['productid'].'&purchaseIDdelete='.$product['fkpurchase'].'">Eliminar</a>
                                    </button>
                                </div>
                            </article>';
                        }
            ...
            <section class="resumen-carrito">
                <h2>Resumen</h2>
                <table>
                    <form action="index.php?Controller=carrito&action=procesarCompra" method="POST">
                        <?php 
                        if(isset($datosCarrito) && is_array($datosCarrito)){
                                foreach ($datosCarrito as $product) {
                                    echo '
                        ...
                        ?>
                        <tr class="last-resumen">
                            <td colspan="3">Total</td>
                            <td id ="precio-total-compra"></td>
                        </tr>
                        <tr>
                            <td colspan="4"><button class="finalizar-compra">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <input type="hidden" name="costoTotalCompra" id="costoTotalCompra" value="">
                        <input type="hidden" name="purchaseIDFK" id="purchaseIDFK" value="<?php if (isset($datosCarrito) && is_array($datosCarrito)){ echo $datosCarrito[0]['fkpurchase'];} ?>">
                    </form>
                </table>
            </section>
        </div>
