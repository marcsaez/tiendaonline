<div class = "container">
    <div class="loginAdmin">
        <h1>ADMIN</h1>
    <form enctype="multipart/form-data" action="http://localhost/ABP%20TIenda/tiendaonline/index.php?Controller=Admin&action=Login" method="POST" class = "formularioAdmin">
        <p>Usuario</p>
